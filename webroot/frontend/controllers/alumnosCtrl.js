app.controller("alumnosCtrlIndex", function ($scope,DTOptionsBuilder, DTColumnBuilder,ngDialog) {
    var vm = this;
    vm.escuelas = {};

    // define table
    vm.dtOptions = DTOptionsBuilder.fromSource('alumnos.json')
    ...
    $scope.clickToOpen = function () {
    	console.log('ok');
        ngDialog.open({ template: 'webroot/frontend/templates/alumnos/add.html', 
...
app.controller("alumnosCtrlAdd", function ($scope,DTOptionsBuilder, DTColumnBuilder,ngDialog,$http) {
    ...
    $scope.clickToOpen = function () {
        console.log('ok');
        ngDialog.open({ template: 'webroot/frontend/templates/menus/add.html', 
                        className: 'ngdialog-theme-default',
                        ariaLabelledById:'menus-add'
                         });
    };
});