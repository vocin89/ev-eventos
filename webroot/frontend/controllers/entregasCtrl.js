app.controller("escuelasCtrlIndex", function ($scope,DTOptionsBuilder, DTColumnBuilder,ngDialog) {
    var vm = this;
    vm.escuelas = {};
...
app.controller("entregasCtrlAdd", function ($scope,DTOptionsBuilder, DTColumnBuilder,ngDialog,$http) {
    
    $scope.egresado = $scope.ngDialogData.egresado;
    ...
    $scope.ini  = function(){
        $http({
            ...
            $scope.modalidad_pagos = response.data.modalidad_pago;
